    ...
    <section className="about">
      <div className="about-section-container">
        <div className="about-text-container">
          ...
          <p>
            Join us and discover the diversity and deliciousness of New
            Zealand's fruit and vegetables.
          </p>
        </div>
        <img
          src={grapesImg}
          alt="hands holding grapes"
          className="about-widescreen-image"
        />
      </div>
      ...
      <div className="about-section-container">
        <div className="about-text-container">
          ...
          <p>
            ...
            and sell it directly to people in your area. You can set your own
            prices and availability. By joining you will not only increase your
            sales, but also help people access fresh and nutritious food that
            they can trust.
          </p>
